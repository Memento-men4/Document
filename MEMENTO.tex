...
\begin{figure}[h]
\centerline{\includegraphics[width=9cm,height=8cm]{overall architecture final.png}}
...
\\\\\\\\
\begin{figure}[h]
\centerline{\includegraphics[width=8cm,height=6cm]{database.jpg}}
\caption{Database}
\label{fig}
\end{figure}
\\
...
\begin{figure}[h]
\centerline{\includegraphics[width=8cm,height=6cm]{CountOfQuestion.png}}
\caption{Count of Question}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=5cm,height=6cm]{BoxplotOfQuestions.png}}
\caption{Boxplot of Question}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=8cm,height=6cm]{CountOfContext.png}}
...
\clearpage
\begin{figure}[h]
\centerline{\includegraphics[width=5cm,height=6cm]{BoxplotOfContext.png}}
\caption{Boxplot of Context}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=8cm,height=5.5cm]{CountofAnswer.png}}
\caption{Count of Answer}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=5cm,height=5.5cm]{BoxplotOfAnswer.png}}
\caption{Boxplot of Answer}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=6cm,height=6cm]{WordCloud.png}}
\caption{WordCloud of Questions, Contexts, Answers}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=9cm,height=3cm]{FinetuningResult.png}}
\caption{Confusion Matrix}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=4cm,height=3cm]{Calculation.png}}
\caption{Score Calculation}
\label{fig}
\end{figure}

\begin{figure}[h]
\centerline{\includegraphics[width=7cm,height=1.5cm]{Outcome.png}}
